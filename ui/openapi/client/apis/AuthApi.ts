...
export class AuthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param loginModel 
     */
    public async apiAuthLoginPost(loginModel: LoginModel, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'loginModel' is not null or undefined
        if (loginModel === null || loginModel === undefined) {
            throw new RequiredError("AuthApi", "apiAuthLoginPost", "loginModel");
        }
     ...
     * @param registerModel 
     */
    public async apiAuthRegisterPost(registerModel: RegisterModel, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'registerModel' is not null or undefined
        if (registerModel === null || registerModel === undefined) {
            throw new RequiredError("AuthApi", "apiAuthRegisterPost", "registerModel");
        }
...
export class AuthApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async apiAuthRegisterPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
